...
```
https://<tunnel>.trycloudflare.com/your-project/asia-east1/lineWebhook?lid={你的UID}
```
...
```
https://asia-east1-your project.cloudfunctions.net/lineWebhook?lid={UID}
```
...
| 檔案 | 用途 | VITE_API_BASE |
|------|------|---------------|
| `.env.development` | 本地開發 | `http://localhost:5001/your project/asia-east1` |
| `.env.production` | 正式部署 | `https://asia-east1-your project.cloudfunctions.net` |
